...
public class FileUtil {
	...
	public static String imgCaches;
	public static String rootPath;
	
	public static void makeAppCacheDir() {
		File file=new File(Environment.getExternalStorageDirectory()+"/wiser");
		if(!file.exists()){
			file.mkdir();
		}
		rootPath=file.getAbsolutePath();
		file=new File(rootPath+"/image");
		if(!file.exists()){
			file.mkdir();
		}
		imgCaches=file.getAbsolutePath();
}

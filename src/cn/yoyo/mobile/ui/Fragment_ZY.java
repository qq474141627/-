...
public class Fragment_ZY extends Fragment implements OnItemClickListener ,OnScrollListener,OnCheckedChangeListener{
	...
	public void onCreate(Bundle savedInstanceState) {
	  ...
	  parameter.setCategory(getResources().getString(R.string.Variety));
	}
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		if(mView==null){
			mView = inflater.inflate(R.layout.fragment_zy, container,
					false);

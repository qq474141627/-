...
public class ImageUtils {
	...
	public static boolean saveBitmap(String uri, Bitmap bitmap) {
		if (bitmap == null || bitmap.isRecycled())
			return false;
		return saveBitmap(new File(FileUtil.imgCaches+ File.separator +FileUtil.getFileName(uri)), bitmap);
	}
	 ...
	 * @return
	 */
	public static boolean isFileImgExists(String fileName) {
		boolean status;
		if (!TextUtils.isEmpty(fileName)) {
			File newPath = new File(FileUtil.imgCaches + File.separator + fileName);
	...
	public static Bitmap getBitmap(String filename){
        ...
        return BitmapFactory.decodeFile(FileUtil.imgCaches + File.separator + filename);  
    }  
